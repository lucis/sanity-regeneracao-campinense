...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/k6d7wvmh/settings/api) and create a token with read rights.
